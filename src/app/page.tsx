...
const facilities = [
  ...
  { name: 'Function Hall', image: '/images/facility-function-hall.jpg', description: 'Ruang serbaguna mewah' },
  { name: 'Shuttle Bus', image: '/images/facility-shuttle-bus.jpg', description: 'Transportasi antar jemput' },
]
